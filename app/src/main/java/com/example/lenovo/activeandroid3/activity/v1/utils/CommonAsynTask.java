...
/**
 * Created by anway on 20/3/19.
 */

public class CommonAsynTask extends AsyncTask<Void, Void, String>  {
...
//    Scanner scanner ;
    ...
    public CommonAsynTask(Context context, String requestString, ResponseInterface myInterface, MethodSelection methodSelection, String IP )
    {
